...
of all data. For each of the OOS esmXscenarios, calculate the L2 distance 
between that and each esmXscenario in the subset data
...
non_candidate_esm <- c("E3SM-1-1", "FIO-ESM-2-0", "GFDL-CM4", "IITM-ESM",
...
compare_projection_coeffs <- function(fulldata, fullpca, subpca, n_eigenvalues = 5){
...
# test functions
compare_projection_coeffs(fulldata = full_data,
                          fullpca = full_pca,
                          subpca = sub_pca,
                          n_eigenvalues = 5)
full_pca_distances(subset_esms = subset,
                   fullpca = full_pca,
                   n_eigenvalues = 5)
