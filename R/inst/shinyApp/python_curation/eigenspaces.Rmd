...
1. Throw out any subsets that have multiple models from the same lineage before
pulling minimums

2. Maybe don't accept any subsets with MRI

3. Other heuristics, like ECS, number of ensemble members, variables.
